...
/***/ "./src/components/mptab-date-select.tsx"
/*!**********************************************!*\
  !*** ./src/components/mptab-date-select.tsx ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MPTABDateSelect: () => (/* binding */ MPTABDateSelect)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
...
function MPTABDateSelect({
  ...
  const [dateParam, setDateParam] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(dates);
  const [allDates, setAllDates] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(getAllDates(dates));
  const [multipleState, setMultipleState] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [removeState, setRemoveState] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const [prevDate, setPrevDate] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(new Date());
  const begOrEndDate = (newDate, allDates) => {
    let begDate = new Date(newDate).getTime();
    let endDate = new Date(newDate).getTime();
    allDates.forEach(compareDate => {
      if (new Date(parseInt(compareDate.date)).getTime() < new Date(begDate).getTime()) {
        begDate = new Date(parseInt(compareDate.date)).getTime();
      }
      if (new Date(parseInt(compareDate.date)).getTime() > new Date(endDate).getTime()) {
  ...
  const removeDate = newDate => {
    setDateParam(dates => {
      const newDates = dates.filter(compareItem => newDate.toDateString() !== new Date(parseInt(compareItem.date)).toDateString());
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    ...
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToggleControl, {
...
/***/ "./src/components/mptab-time-select.tsx"
/*!**********************************************!*\
  !*** ./src/components/mptab-time-select.tsx ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MPTABTimeSelect: () => (/* binding */ MPTABTimeSelect)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
...
function MPTABTimeSelect({
  hours,
  input
}) {
  const [allHours, setAllHours] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(hours);
  const theHours = allHours.map((hour, index) => {
    const removeItem = () => {
    ...
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Flex, {
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.FlexItem, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TimePicker.TimeInput, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Start', 'mptab-domain'),
            value: hour.open,
            onChange: newTime => {
          ...
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TimePicker.TimeInput, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('End', 'mptab-domain'),
            value: hour.close,
            onChange: newTime => {
              changeItem(newTime, false);
            }
          })
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.FlexBlock, {
          children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
            ...
            children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Remove', 'flexible-open-hours-domain')
          })
        })]
      })
    });
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [theHours, allHours.length < 4 && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      variant: 'secondary',
      onClick: () => {
        setAllHours(oldHours => {
      ...
      children: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Add More', 'mptab-domain')
    })]
  });
}
...
/***/ "./src/input/mptab-event-date.tsx"
/*!****************************************!*\
  !*** ./src/input/mptab-event-date.tsx ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MPTABEventDate: () => (/* binding */ MPTABEventDate)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_mptab_date_select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/mptab-date-select */ "./src/components/mptab-date-select.tsx");
/* harmony import */ var _components_mptab_alias__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/mptab-alias */ "./src/components/mptab-alias.tsx");
/* harmony import */ var _utility_is_JSON__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utility/is-JSON */ "./src/utility/is-JSON.ts");
/* harmony import */ var _types_mptab_date_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../types/mptab-date-types */ "./src/types/mptab-date-types.ts");





function MPTABEventDate({
  datesInput,
  aliasInput
}) {
  if (!datesInput[0]) {
  ...
  let dates = [];
  if ((0,_utility_is_JSON__WEBPACK_IMPORTED_MODULE_3__.isJSON)(datesInput[0].value) && _types_mptab_date_types__WEBPACK_IMPORTED_MODULE_4__.DatesSchema.safeParse(JSON.parse(datesInput[0].value))) {
    dates = JSON.parse(datesInput[0].value);
  }
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_mptab_date_select__WEBPACK_IMPORTED_MODULE_1__.MPTABDateSelect, {
      dates: dates,
      input: datesInput
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_mptab_alias__WEBPACK_IMPORTED_MODULE_2__.MPTABAlias, {
      element: [{
...
/* harmony import */ var _input_mptab_event_date__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./input/mptab-event-date */ "./src/input/mptab-event-date.tsx");
/* harmony import */ var _components_mptab_time_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/mptab-time-select */ "./src/components/mptab-time-select.tsx");
...
/* harmony import */ var _types_mptab_hour_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./types/mptab-hour-types */ "./src/types/mptab-hour-types.ts");
...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_1___default()(() => {
  const root = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createRoot)(document.getElementById('mptab-event-date-select'));
  const hourRoot = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createRoot)(document.getElementById('mptab-event-hour-select'));
  //date
  const mindateInput = document.querySelector('#mptab-event_date_start_field');
  const maxdateInput = document.querySelector('#mptab-event_date_end_field');
  const alldateInput = document.querySelector('#mptab-event_date_all_field');
  if (!mindateInput || !maxdateInput || !alldateInput) {
    throw new Error('dates_field not found');
  }
  //alias
  const startAliasInput = document.querySelector('#mptab-event_date_alias_field');
  if (!startAliasInput) {
  ...
  root.render((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_input_mptab_event_date__WEBPACK_IMPORTED_MODULE_3__.MPTABEventDate, {
      datesInput: [alldateInput, mindateInput, maxdateInput],
      aliasInput: [startAliasInput]
    })
  }));
  //Hours
  const hourInput = document.querySelector('#mptab-event_hour_field');
  if (!hourInput) {
    throw new Error('mptab-event-hour-field not found');
  }
  let hours = [];
  if ((0,_utility_is_JSON__WEBPACK_IMPORTED_MODULE_5__.isJSON)(hourInput.value) && _types_mptab_hour_types__WEBPACK_IMPORTED_MODULE_6__.HoursSchema.safeParse(JSON.parse(hourInput.value))) {
    hours = JSON.parse(hourInput.value);
  }
  hourRoot.render((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_mptab_time_select__WEBPACK_IMPORTED_MODULE_4__.MPTABTimeSelect, {
      hours: hours,
      input: hourInput
    })
  }));
...
/******/ })()
;
//# sourceMappingURL=event_meta.js.map